...
using ThabeloSelbypart2.Models;

namespace ThabeloSelbypart2.Controllers
{
    public class LecturerClaim : Controller
    {
        ...
        [HttpPost]
        public IActionResult CreateEdit(ThabeloSelbypart2.Models.LecturerClaim model)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Register_user(ThabeloSelbypart2.Models.register model)
        {
            if (ModelState.IsValid)
            {
